...
public class DiagnosticsOverview extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vesicular.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        epithelium.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        swabs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        probang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        nonStructural.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
